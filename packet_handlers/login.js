require('./PacketHandler.js').SetHandler(0x0001, function (socket, packet) {
...
require('./PacketHandler.js').SetHandler(0x000B, function (socket, packet) {
	// Request worlds
	var packet = new global.PacketWriter();
	...
	packet = new global.PacketWriter();
	packet.writeUInt16(0x000A);
...
require('./PacketHandler.js').SetHandler(0x0006, function (socket, packet) {
	// Request world state
